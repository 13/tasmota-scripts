...
Rule2
  ...
  ON event#ROLLER1="" DO Backlog mem1 2; mem2 1; Publish shellies/shellyswitch25-C45BBE6B07DC/roller/0/command open ENDON
  ON event#ROLLER1==0 DO Backlog mem1 2; mem2 1; Publish shellies/shellyswitch25-C45BBE6B07DC/roller/0/command open ENDON
  ON event#ROLLER1==1 DO Backlog mem1 2; mem2 0; Publish shellies/shellyswitch25-C45BBE6B07DC/roller/0/command close ENDON
  ON event#ROLLER1==2 DO Backlog mem1 %mem2%; Publish shellies/shellyswitch25-C45BBE6B07DC/roller/0/command stop ENDON
  ON mqtt#connected DO Subscribe Pos, shellies/shellyswitch25-C45BBE5FB259/roller/0/pos ENDON
  ON Event#Pos=0 DO mem3 0 ENDON
  ON Event#Pos=100 DO mem3 1 ENDON
  ON Event#Pos DO Unsubscribe Pos ENDON
  ON Button3#state DO event ROLLER2=%mem3% ENDON
  ON event#ROLLER2="" DO Backlog mem3 2; mem4 1; Publish shellies/shellyswitch25-C45BBE5FB259/roller/0/command open ENDON
  ON event#ROLLER2==0 DO Backlog mem3 2; mem4 1; Publish shellies/shellyswitch25-C45BBE5FB259/roller/0/command open ENDON
  ON event#ROLLER2==1 DO Backlog mem3 2; mem4 0; Publish shellies/shellyswitch25-C45BBE5FB259/roller/0/command close ENDON
  ON event#ROLLER2==2 DO Backlog mem3 %mem4%; Publish shellies/shellyswitch25-C45BBE5FB259/roller/0/command stop ENDON
```
