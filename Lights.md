...
ON event#chcksr0<%sunrise% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
ON event#chckss0>%sunset% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
...
ON event#chcksr1<%sunrise% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
ON event#chckss1>%sunset% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
...
ON event#chcksr2<%sunrise% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
ON event#chckss2>%sunset% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
...
ON event#chcksr3<%sunrise% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
ON event#chckss3>%sunset% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
...
ON event#chcksr4<%sunrise% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
ON event#chckss4>%sunset% DO Backlog Power1 1; RuleTimer1 RuleTimer1+30 ENDON
```
---
## STCK2_GANG
### Settings
