...
ON Power1#state DO Backlog event readT1; var1 %value%; IF (%value%==1 && %var10%==0) RuleTimer1 600 ELSE RuleTimer1 0 ENDIF ENDON
ON Rules#Timer=1 DO Backlog Var10 0; Power1 0 ENDON
...
ON event#chcksr0<%sunrise% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
ON event#chckss0>%sunset% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
...
ON event#chcksr1<%sunrise% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
ON event#chckss1>%sunset% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
...
ON event#chcksr2<%sunrise% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
ON event#chckss2>%sunset% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
...
ON event#chcksr3<%sunrise% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
ON event#chckss3>%sunset% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
...
ON event#chcksr4<%sunrise% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
ON event#chckss4>%sunset% DO Backlog event readT1; IF (%var10%<30) RuleTimer1 30 ENDIF; Power1 1 ENDON
```
---
## STCK2_GANG
### Settings
