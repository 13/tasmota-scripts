...
Backlog PowerSet 60.0; VoltageSet 228; CurrentSet 263.16
...
- plugs2
- var1 = Total Watt Inv
- var2 = Total Watt Inv + Total Watt .00 Temp
- var3 = Total Watt to Operate

Rule1
  ON System#Boot DO Backlog var1 0; var2 0; var3 200; ENDON
  ON Energy#Power DO var1 %value% ENDON
  ON var3#state<800 DO Backlog var10 0; IF (%value% != %mem3%) WebSend [192.168.22.59:8050] /setMaxPower?p=%var3% ENDIF; mem3 %value% ENDON
  ON var3#state>=800 DO Backlog var10 0; IF (%value% != %mem3%) WebSend [192.168.22.59:8050] /setMaxPower?p=800 ENDIF; mem3 %value% ENDON
  ON mqtt#connected DO Subscribe PowerTotal, muh/power/3em/json, total ENDON
  ON Event#PowerTotal DO Backlog CalcRes 0; var2 = (var1 + %value%)*2; ADD2 0; var3 %var2% ENDON
