...
```
Rule1
  on Switch1#Boot do Publish2 muh/portal/HD/json {"state": %value%, "time": "%timestamp%", "tstamp": %LOCALTIME%} endon
  on Switch2#Boot do Publish2 muh/portal/HDL/json {"state": %value%, "time": "%timestamp%", "tstamp": %LOCALTIME%} endon
