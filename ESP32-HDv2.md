...
```
Rule1
  on Switch1#Boot do Publish2 muh/portal/HD/json {"state": %value%, "tstamp": "%timestamp%"} endon
  on Switch2#Boot do Publish2 muh/portal/HDL/json {"state": %value%, "tstamp": "%timestamp%"} endon
